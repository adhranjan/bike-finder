...
<div class="header-bg">
	<div class="wrap"> 
			...
			<div class="total">
				<div class="header">
					<div class="box_header_user_menu">
						<ul class="user_menu"><li class=""><a href=""><div class="button-t"><span>Create an Account</span></div></a></li></ul>
					</div>
					<div class="clear"></div> 
				 ...
				 <div class="header_bottom_right_images">
					    ...
					    <form method="post" method="post" name="login" action="">
						    ...
						    <div>
						    	<span><label>E-MAIL <?php
															...
															if($num_rows!=1)
															{
															echo "<span id='notvalid'> Not registered yet, <a href='register.php' style='text-decoration:none';>Register?</a></span>";	
																	$formError++;
															}
														else if($email=="")
															{
				  ...
				  <div class="content-wrapper">		  
						<div class="content-top">
							  	<div class="box_wrapper"><h1>Latest Uploads</h1>
								</div>
							 <div class="text"> 
							 	<?php
							 	$query="SELECT * FROM bike b  inner join user u on u.userID= b.userID WHERE (bikeSold=0) ORDER BY BikeID DESC LIMIT 3" ; //query
									$result=$db->query($query);
		...
		<div class="header-para">
				...
				<div class="box-title">
					<h1><span class="title-icon"></span><a href="">Limited Stocks</a></h1>
				</div>

				<div class="section group example">
						<?php
						$query="SELECT * FROM bike WHERE  (ItemRemaining>=1&& ItemRemaining<=3) AND bikeVisibility=1 LIMIT 3" ; 
						$result=$db->query($query);
						while ( $row = mysqli_fetch_array($result, MYSQL_BOTH)) {
						$bikeID=$row[0];
						$ItemRemaining=$row[8];
